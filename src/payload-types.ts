...
export interface Config {
  ...
  globals: {
    'home-page': HomePage;
    'approach-settings': ApproachSetting;
  ...
  globalsSelect: {
    ...
    'approach-settings': ApproachSettingsSelect<false> | ApproachSettingsSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "approach-settings".
 */
export interface ApproachSetting {
  id: number;
  eyebrow?: string | null;
  title?: string | null;
  description?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "approach-settings_select".
 */
export interface ApproachSettingsSelect<T extends boolean = true> {
  eyebrow?: T;
  title?: T;
  description?: T;
  cta?: T;
